  ...
  (
    ...
    return (
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
              ...
              <div className="flex justify-between items-center w-full">
                <div className="flex flex-wrap items-center">
                  ...
                  {selectedValues.length > maxCount && (
                    <Badge
                      className={cn('bg-transparent text-foreground border-foreground/1 hover:bg-transparent', multiSelectVariants({ variant }))}
        ...
        <PopoverContent className="w-auto p-0 h-full overflow-y-auto" align="start" onEscapeKeyDown={() => setIsPopoverOpen(false)}>
          <Command>
