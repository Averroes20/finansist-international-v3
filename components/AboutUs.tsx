      ...
      <section id="about-us" className="scroll-mt-20 bg-white dark:bg-slate-800">
        <div className="flex flex-col space-y-4 container px-5 md:px-0 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 md:grid-flow-row gap-5 md:gap-0 md:px-32">
            <AnimatedComponent threshold={0.5} once={true} effect="fade-in-left" className="md:col-span-5 md:items-center md:justify-center md:content-center">
            ...
            <AnimatedComponent
              ...
              className="flex flex-col md:col-span-1 items-center gap-2 gap-y-2 md:mb-0 md:gap-0 md:justify-self-start md:ml-5"
            >
              <Image
