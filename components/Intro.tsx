        ...
        <div className="grid grid-cols-1 gap-4 md:gap-0 md:grid-cols-2">
          <div className="">
            <div className="space-y-3">
              ...
              <h1>
                <span className="font-santaCatalina font-normal block py-6 text-slate-800 text-4xl md:text-6xl motion-translate-x-in-[0%] motion-translate-y-in-[50%] motion-opacity-in-[0%] motion-duration-[1.04s] motion-delay-[0.50s]/translate motion-delay-[0.50s]/opacity motion-ease-spring-smooth">
                  {subtitle}
                </span>
              </h1>
              <p className="font-facultyGlyphic font-extrabold text-lg md:text-2xl text-slate-800 motion-translate-x-in-[0%] motion-translate-y-in-[50%] motion-opacity-in-[0%] motion-duration-[1.04s] motion-delay-[0.70s]/translate motion-delay-[0.70s]/opacity motion-ease-spring-smooth">
                {description}
              </p>
            </div>
