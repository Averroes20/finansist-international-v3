...
const Blogs = async () => {
  ...
  return (
    <>
      <div className='h-10 bg-gradient-to-b from-white to-slate-100' />
      <section id="blog" className="md:min-h-screen h-[80vh] flex justify-center items-center bg-slate-100">
